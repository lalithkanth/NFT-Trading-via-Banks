...
function Team(props) {
    ...
    const [dataBlock] = useState({
        ...
        title: 'Meet our TEAM',
        desc: 'Who we are',
        text: 'We are a diverse and talented team dedicated to achieving our goals and delivering exceptional results. Each member of our team brings a unique set of skills, experiences, and perspectives, creating a dynamic and collaborative environment.'
    })
    return (
