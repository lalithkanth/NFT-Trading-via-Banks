...
function Work(props) {
    ...
    const [dataBlock] = useState({
        ...
        title: 'Steps Involved in Network',
        desc: 'Set up your wallet, choose a compatible cryptocurrency wallet like MetaMask and explore NFT marketplaces search for collections of interest, view the NFTs within the collection.'
    })
    return (
