                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-12">
                            <div className="item-details" data-aos="fade-left" data-aos-duration="800">
                                ...
                                <p className="desc">The Iron Man suit is a technological marvel, equipped with an array of weapons, flight capabilities, enhanced strength, and advanced gadgets. It is powered by an Arc Reactor, a fictional clean energy source developed by Tony Stark. Over time, Stark continues to upgrade and refine the suit, adding new features and capabilities.</p>
